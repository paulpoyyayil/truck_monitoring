...
urlpatterns = [
    ...
    path("admin_reject_users/<int:id>",views.admin_reject_users,name="admin_reject_users"),

    path("view_approved_driver",views.view_approved_driver,name="view_approved_driver"),

    path("admin_approve_drivers/<int:id>",views.admin_approve_drivers,name="admin_approve_drivers"),

    path("admin_reject_drivers/<int:id>",views.admin_reject_drivers,name="admin_reject_drivers"),
